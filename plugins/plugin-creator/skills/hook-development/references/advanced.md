...
## PermissionRequest Auto-Handling

Automatically approve or deny permission dialogs:
  ...
  "PermissionRequest": [
    {
      ...
      "hooks": [
        {
          "type": "prompt",
          "prompt": "Auto-approve Read operations for project files. Check if path is within $CLAUDE_PROJECT_DIR. Return JSON with permissionDecision: 'allow' or 'ask'."
        }
      ]
    }
  ]
...
```json
{
  "hookSpecificOutput": {
    ...
    "permissionDecisionReason": "Safe read operation within project"
  }
}
```
