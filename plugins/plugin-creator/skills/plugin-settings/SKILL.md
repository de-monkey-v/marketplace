...
description: Plugin settings file pattern (.local.md) guide. This skill should be used when the user asks about "plugin settings", "플러그인 설정", "설정 파일", ".local.md", or needs guidance on per-project plugin configuration.
---
...
- **`references/security.md`** - Security best practices for settings handling
...
- **[hook-development](../hook-development/SKILL.md)** - Hooks that read settings
- **[command-development](../command-development/SKILL.md)** - Commands that read/write settings

### Related Agents
- **settings-creator** - Create settings files and parsing scripts
- **plugin-validator** - Validate settings patterns
